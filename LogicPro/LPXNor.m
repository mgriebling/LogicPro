...
//    [path moveToPoint:CGPointMake(x+328.0*scale, y+111.0*scale)];
//    [path addArcWithCenter:CGPointMake(x+328.0*scale, y+111.0*scale) radius:25.0*scale startAngle:M_1_PI endAngle:M_1_PI-0.0001 clockwise:YES];
