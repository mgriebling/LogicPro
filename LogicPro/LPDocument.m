...
static NSString *LPDocumentUndoKeysObservationContext = @"com.apple.LPDocument.undoKeys";
static NSString *LPDocumentUndoObservationContext = @"com.apple.LPDocument.undo";
...
static NSString *LPDocumentNewTypeName = @"com.apple.sketch2";
static NSString *LPDocumentNewVersion1TypeName = @"com.apple.sketch1";
...
static NSInteger LPDocumentCurrentVersion = 2;
...
//@interface LPMapTableOwner : NSObject {
//@private
//    NSMapTable *_mapTable;
//}
//@end
//@implementation LPMapTableOwner
//- (id)init {
//    self = [super init];
...
// Conformance to the NSObject(LPGateScriptingContainer) informal protocol.
- (NSScriptObjectSpecifier *)objectSpecifierForGraphic:(LPGate *)graphic {
...
- (NSArray *)rectangles {
    return [self graphicsWithClass:[LPRectangle class]];
}

- (NSArray *)circles {
    return [self graphicsWithClass:[LPCircle class]];
}

- (NSArray *)lines {
    return [self graphicsWithClass:[LPLine class]];
}

- (NSArray *)textAreas {
    return [self graphicsWithClass:[LPText class]];
}

- (NSArray *)images {
    return [self graphicsWithClass:[LPImage class]];
}
