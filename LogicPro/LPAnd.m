...
- (UIBezierPath *)bezierPathForDrawing {
    ...
    CGFloat scale = MIN(w/IWIDTH_AND, h/IHEIGHT_AND);
    ...
    [path addCurveToPoint:CGPointMake(x, y) controlPoint1:CGPointMake(x+174.0*scale, y) controlPoint2:CGPointMake(x, y)];
